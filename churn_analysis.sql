...
-- inserting customer data from raw data
...
-- inserting subscription data from raw data
INSERT INTO Subscription (
    CustomerID, TenureMonths, Contract, PaperlessBilling
)
SELECT
    CustomerID, TenureMonths, Contract, PaperlessBilling
FROM Raw_Data;

-- inserting services data from raw data
...
-- inserting billing data from raw data
INSERT INTO Billing (
